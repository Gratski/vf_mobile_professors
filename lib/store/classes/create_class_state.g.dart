...
part of 'create_class_state.dart';
...
mixin _$CreateClassState on _CreateClassState, Store {
  ...
  final _$descriptionAtom = Atom(name: '_CreateClassState.description');
  ...
  final _$durationAtom = Atom(name: '_CreateClassState.duration');
  ...
  final _$categoryIdAtom = Atom(name: '_CreateClassState.categoryId');
  ...
  final _$caloriesAtom = Atom(name: '_CreateClassState.calories');
  ...
  @override
  dynamic setCategoryId(int newCategoryId) {
    final _$actionInfo = _$_CreateClassStateActionController.startAction();
    try {
