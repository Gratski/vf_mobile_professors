  ...
  Widget build(BuildContext context) {
    return CustomScrollView(
      slivers: <Widget>[
        AppHeaderWidget(
          'Class Details',
          subTitle: 'Language: ${editOrCreateClassStore.languageContext.languageCode}',
        ),
        // fields to edit
        SliverList(
          key: GlobalKey(),
              ...
              Form(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                                  ...
                                  child: Container(
                                    child: Row(
                                      children: <Widget>[
                                        ...
                                        // parent category
                                        _buildBadge(TextsBuilder.regularText('${editOrCreateClassStore.subCategory.parent.designation}')),

                                        // class category
                                        _buildBadge(TextsBuilder.regularText('${editOrCreateClassStore.subCategory.designation}')),

                                        Container(
                                          margin: EdgeInsets.only(left: 10),
                                          child: Icon(Icons.edit, color: AppColors.fontColor,),
                                        )
                    ...
                    /// Burned Calories
                    _buildTextField('Expected KCal loss', '30,9',
                            (value) {
                          editOrCreateClassStore.setCalories(value);
                        }, caloriesController, false, inputFormat: TextInputType.number),
                                  ...
                                  children: editOrCreateClassStore
                                    ...
                                    return Flexible(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            editOrCreateClassStore.setDuration(d);
                                          },
                                          child: Container(
                                            margin: EdgeInsets.only(
                                                left: 5, right: 5),
                                            ...
                                            decoration: BoxDecoration(
                                              color: (editOrCreateClassStore.duration == d) ? AppColors.regularGreen : AppColors.bgMainColor,
                                              border: Border.all(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          SizedBox(
                            ...
                            child: ButtonsBuilder.greenFlatButton('SUBMIT', () { }),
                          )
                        ],
                      ),
                    ),
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            keyboardType:
                (isMultiline) ? TextInputType.multiline : inputFormat,
          ),
        ],
      ),
    );
