...
class TextsBuilder {
  ...
  static TextSpan h1BoldSpan(String text) {
    return TextSpan(text: text, style: TextStyle( fontSize: _FONT_SIZE_H1, fontFamily: _FONT_FAMILY_BOLD));
  }

  /// SPAN
  static TextSpan h3LightSpan(String text) {
    return TextSpan(text: text, style: TextStyle( fontSize: _FONT_SIZE_H3, fontFamily: _FONT_FAMILY_REGULAR));
  }

  static TextSpan regularSpan(String text) {
    return TextSpan(text: text, style: TextStyle( fontSize: _FONT_SIZE_REGULAR, fontFamily: _FONT_FAMILY_REGULAR ));
  }
  ...
  static Text regularText(String text) {
    return Text(text, style: TextStyle( fontSize: _FONT_SIZE_REGULAR, fontFamily: _FONT_FAMILY_REGULAR));
  }
