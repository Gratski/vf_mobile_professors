...
class SplashFirstScreen extends AbstractSplashScreen {

  SplashConstants splashConstants = SplashConstants();
  VoidCallback callback;
  SplashFirstScreen(this.callback);
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: ExactAssetImage('assets/images/onboarding_1.png', ),
                  ),
                ),
              ),
            ),
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      child: TextsBuilder.h3Bold(
                        AppLocalizations.of(context).translate(splashConstants.firstPageHeader)
                      ),
                    ),
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.only(top: MediaQuery.of(context).size.height / 40),
                      child: TextsBuilder.regularText(AppLocalizations.of(context).translate(splashConstants.firstPageText)),
                    ),
